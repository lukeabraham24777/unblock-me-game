...
\begin{table}[t]
  \centering\small
  \caption{Band occupancy and linearity for the original notch and the three widened variants
  (Fashion-MNIST MLP, 3 epochs, means over 3 seeds). ``\% pre-act.\ in band'' is the fraction of hidden
  pre-activations inside $[\text{lo},\text{hi}]$, averaged over the two hidden layers.}
...
Table~\ref{tab:variants}). Three findings stand out.
...
activation at all comes equally close there. An ablation over fifteen variants confirms that the
