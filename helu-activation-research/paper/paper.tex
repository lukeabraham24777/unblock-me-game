...
non-linear; at the proposed $\delta=0.01$ it is the identity in all but name. All code, raw results,
and figures are released alongside this document.
\end{abstract}
...
function $x+\delta x^2/(2W)$ (piecewise-linear) trains well once $\delta$ is of order one, reaching
within two points of ReLU on Fashion-MNIST, but at the proposed $\delta=0.01$ it is
indistinguishable from the linear control. Across all of these designs the same rule holds: an
